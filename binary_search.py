...
def main():
    ...
    print(search_section([1, 2, 3, 4, 5], 2))
    print(search_section([1, 2, 3, 4, 5], 2.5))
    print(search_section([1, 2, 3, 4, 5], 3.5))
    print(search_section([1, 2, 3, 4, 5], 0))
    print(search_section([1, 2, 3, 4, 5], 5))
    print(search_section([1, 2, 3, 4, 5], 5.0001))
